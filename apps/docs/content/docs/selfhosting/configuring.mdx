...
| Chat retention   | How many days to keep chat history                    | 90 days   |
...
These volumes persist across container restarts and rebuilds. Use `docker compose down -v` to delete them (irreversible).
